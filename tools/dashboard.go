	...
	r.register(&Tool{
		...
		Parameters: ToolParameters{
			...
			Properties: map[string]ToolProperty{
				...
				"w":           {Type: "integer", Description: "Panel width in grid units (max 24). 0=auto (large charts=17, small=7). Do NOT use pixel values!", Default: 0},
				"h":           {Type: "integer", Description: "Panel height in grid units (default 7). 0=auto. Do NOT use pixel values!", Default: 0},
			},
			Required: []string{"filename"},
		},
